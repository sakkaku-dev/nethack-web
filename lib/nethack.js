...
[ "_main", "_shim_graphics_set_callback", "_mapglyph", "_display_inventory", "_malloc", "_free", "_fflush", "___set_stack_limits", "onRuntimeInitialized" ].forEach(prop => {
...
function js_helpers_init() {
 ...
 installHelper(createPointerValue);
 ...
 function createPointerValue(name, type, value) {
  if (!Array.isArray(value)) throw new TypeError(`expected ${name} return type to be array`);
  if (value.length == 0 || !Array.isArray(value[0])) throw new TypeError(`expected ${name} return type to be array or contain values`);
 }
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 1683472;

var ___start_em_js = Module["___start_em_js"] = 1800544;

var ___stop_em_js = Module["___stop_em_js"] = 1806286;
